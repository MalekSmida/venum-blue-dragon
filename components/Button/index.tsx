  ...
  return (
    <Link href={link}>
      <div className="group	relative m-0.5 inline-block h-c-53 w-44 -skew-x-c-20 cursor-pointer border border-white px-4 py-2 focus:outline-none">
        ...
        <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 skew-x-c-20 transform select-none text-2xl text-white mix-blend-difference transition-colors">
          {title}
        </span>
      </div>
    </Link>
